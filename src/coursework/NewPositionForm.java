 ...
 * @author user
 */
public class NewPositionForm extends javax.swing.JDialog {

    private String position;
    private int salary;

    public NewPositionForm(java.awt.Frame parent, String title, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Введите данные должности:");

        jLabel2.setText("Наименование:");

        jLabel3.setText("Зарплата:");
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        setPosition(jTextField1.getText());
        setSalary(Integer.valueOf(jTextField2.getText()));
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewPositionForm dialog = new NewPositionForm(new javax.swing.JFrame(), "", true);
