 ...
 * @author user
 */
public class NewMenuForm extends javax.swing.JDialog {

    private int price;
    private int weight;
    private String name;

    public NewMenuForm(java.awt.Frame parent, String title, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Введите данные пункта меню:");
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        setPrice(Integer.valueOf(jTextField3.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewMenuForm dialog = new NewMenuForm(new javax.swing.JFrame(), "", true);
