...
public class NewEmployeeForm extends javax.swing.JDialog {
    ...
    public NewEmployeeForm(java.awt.Frame parent,String title,boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Введите данные сотрудника:");
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        ...
        setPosition(jTextField3.getText());
        setNumber(jTextField2.getText());
        dispose();
